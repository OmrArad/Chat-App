...
public class SettingsActivityPreLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.setting_activity_pre_login);
        ...
        themeSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(SettingsActivityPreLogin.this, "Dark theme applied", Toast.LENGTH_SHORT).show();
                } else {
                    setTheme(R.style.AppTheme_Light);
                    Toast.makeText(SettingsActivityPreLogin.this, "Light theme applied", Toast.LENGTH_SHORT).show();
                }
